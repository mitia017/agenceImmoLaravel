        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="relative h-80 bg-gray-200 overflow-hidden">
                        ...
                        @if ($property->images->count())
                            <img id="carousel-image" src="{{ asset('storage/' . $property->images[0]->path) }}"
                                class="w-full h-full object-cover" alt="Image du bien">
                        @else
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                const images = @json($property->images->pluck('path')->map(fn($p) => asset('storage/' . $p))->values());
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl border border-gray-200 p-6 sticky top-24 shadow-sm">
                    ...
                    <form method="POST" id="message" action="{{ route('property.contact', $property) }}"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="relative">
                                ...
                                <i
                                    class="fas fa-user-friends absolute left-3 top-2/3 transform -translate-y-1/2 text-gray-400"></i>
                            ...
                            <div class="relative">
                                ...
                                <i
                                    class="fas fa-envelope absolute left-3 top-2/3 transform -translate-y-1/2 text-gray-400"></i>
                            ...
                            <div class="relative">
                                ...
                                <i
                                    class="fas fa-phone-alt absolute left-3 top-2/3 transform -translate-y-1/2 text-gray-400"></i>
